 ...
 * {@link AdaptiveReturnUpdatingPolicy} (with {@link WidrowHoffLearner})
 * instead. It is moved from the source and left here for test purposes.
 * <p>
...
public class EpsilonGreedyLearnerWithDiscount extends EpsilonGreedyLearner {
	...
	static Logger logger = Logger
			.getLogger(EpsilonGreedyLearnerWithDiscount.class);
	...
	public EpsilonGreedyLearnerWithDiscount() {
		super();
	}

	public EpsilonGreedyLearnerWithDiscount(final int numActions,
			final double epsilon) {
		super(numActions, epsilon);
	}
	...
	public void setup(final ParameterDatabase parameters, final Parameter base) {
		...
		discount = parameters.getDoubleWithDefault(base
				.push(EpsilonGreedyLearnerWithDiscount.P_DISCOUNT), defBase
				.push(EpsilonGreedyLearnerWithDiscount.P_DISCOUNT), discount);
